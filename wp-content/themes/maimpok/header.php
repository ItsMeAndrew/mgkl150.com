...
<![endif]-->
<?php $scheme = get_option(PADD_THEME_SLUG . '_color_scheme','gray'); ?>
...
<div id="container">
	...
	<div id="header" <?php echo (!is_home()) ? 'class="header-single"' : 'class="header-groupe"';?>>
		...
		<div id="body-wrapper">
			...
			<div id="padd-featsubs">
				...
				<div id="padd-subscribed">
					<div id="padd-subscribed-wrapper">
